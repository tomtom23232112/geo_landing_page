// Hero preview card — replaces the technical scanner with a conversion-focused
// "what you'll receive" preview: a sample GEO Visibility Report card with score
// ring + 3 priority findings. Cleaner, more legible, less intimidating.
const { useState: useStateP, useEffect: useEffectP, useRef: useRefP } = React;

function HeroPreview({ domain, accent = "#c84e22" }) {
  const target = (domain && domain.length > 1)
    ? cleanDomain(domain)
    : "yourcompany.com";
  ...
  // Re-animate score whenever target domain changes (gentle pulse)
  useEffectP(() => {
  ...
  return (
    ...
    >
      {/* Header bar — looks like a report cover */}
      <div style={{
            ...
            {findings.map((f, i) => (
              <div key={i} style={{
                ...
                <span className="mono" style={{
                  ...
                  textTransform: 'uppercase',
                  color: f.sev === 'High' ? accent : '#b08900',
                }}>
                  ● {f.sev}
                </span>
                <div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            borderRadius: '50%', background: '#3d6b4a',
